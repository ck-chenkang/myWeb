...
但是，**图片、表单元素**一律看作是文本，它们并不是盒子。这个很好理解，比如说，一张图片里并不能放东西，它自己就是自己的内容。
...
![image-20211013170029046](Imag/image-20211013170029046.png)

代码演示：

![image-20211013170048941](Imag/image-20211013170048941.png)
...
![image-20211013170139315](Imag/image-20211013170139315.png)

IE盒子模型：

![image-20211013170156032](Imag/image-20211013170156032.png)
...
![image-20211013170244542](Imag/image-20211013170244542.png)
...
![image-20211013170322499](Imag/image-20211013170322499.png)
...
![image-20211013170420767](Imag/image-20211013170420767.png)
...
![image-20211013171436620](Imag/image-20211013171436620.png)
...
![image-20211013171702147](Imag/image-20211013171702147.png)
...
![image-20211013171807724](Imag/image-20211013171807724.png)
...
![image-20211013171850301](Imag/image-20211013171850301.png)

**题目3**：现在给你一个盒子模型图，请写出代码，试着用最最简单的方法写。

![image-20211013171907749](Imag/image-20211013171907749.png)
...
![image-20211013171952552](Imag/image-20211013171952552.png)
...
![image-20211013172139182](Imag/image-20211013172139182.png)

比如`border:10px ridge red;`这个属性，在chrome和firefox、IE中有细微差别：（因为可以显示出效果，因此并不是兼容性问题，只是有细微差别而已）

![image-20211013172155763](Imag/image-20211013172155763.png)
...
![image-20211013172610523](Imag/image-20211013172610523.png)
...
![image-20211013172744905](Imag/image-20211013172744905.png)
...
![image-20211013172809900](Imag/image-20211013172809900.png)
...
![image-20211013172942326](Imag/image-20211013172942326.png)

（2）然后将border的底部取消：

![image-20211013173001360](Imag/image-20211013173001360.png)

（3）最后设置border的左边和右边为白色或者**透明**：

![image-20211013173015621](Imag/image-20211013173015621.png)
...
![image-20211013173051671](Imag/image-20211013173051671.png)

另外，我们在上方代码的基础之上，再加一个 `border-radus: 20px;` 就能画出一个扇形。

## 盒子模型有啥用

我也不知道有啥用，但是我知道有用，没有这个元素堆叠起来不是乱套了吗